...
@section('title','Instrukto`rni Ro`yhatga olish')
@section('controlad')
    
<div class="container-fluid">
    <div class="row">
     
            <h1>Instrukto`rlarni ro`yhatga olish</h1>
            <hr>
            <form action="{{ route('admin.create') }}" method="POST">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Isim Familiya" name="firstname"  value="{{old('firstname')}}">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{ $item->seriya }}</td>
                        <td>{{ $item->adress }}</td>                          
                        <td><a href="{{ route('adminjami3',$item->id) }}" class="btn btn-success">
                        ...
                        <td>  
                            <form method="POST" class="delete_form" action="{{ route('qanstur.destroy',$item->id)}}">
                                @csrf                                       
