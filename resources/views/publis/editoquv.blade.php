...
@section('control')
    <div class="container-fluid">
        <div class="row">
             ...
             <form action="{{ route('show',$data->number) }}" method="GET">
            ...
            <button type="submit" class="btn btn-info">
                ...
                <form action="{{ route('update',$date->id) }}" method="POST">
                   ...
                   <div class="row">                   
                        ...
                        <div class="form-group col-6">
                            <label for="exampleFormControlInput1" class="form-label">Timani</label>
                            <input type="text" class="form-control" placeholder="Timani" name="adress"  value="{{$date->adress}}">
