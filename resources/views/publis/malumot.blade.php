...
@section('control')
    {{-- <div class="row">
        ...
        <form action="{{ route('new.getlist') }}" method="GET" class="d-flex">   
            @csrf          
...
<div class="row">
<form action="{{ route('creategroup') }}" method="POST" class="d-flex">
    @csrf
            <div class="col-3 m-2">
            ...
            <table class="table table-dark table-hover" id="wid">
                ...
                @foreach ($col as $item)
                    <tr>
                        ...
                        <td>{{ $item->data2 }}</td>
                        <td>
                            <a href="{{ route('indexs',$item->id) }}" class="btn btn-success">
                        ...
                        <td><a href="{{ route('index',$item->number) }}" class="btn btn-primary">
                        ...
                        <td>
                            <form action="{{ route('show',$item->number) }}" method="GET">
